...
/*
            ...
            */
            ...
            int cantidades = 10;
            ClaseArrayCadenas AC1 = new ClaseArrayCadenas(cantidades);
            AC1.GenerarSerieExamenIterativo(cantidades);
            AC1.MostrarArray();

            
            
            string path = "C:/UPC/PRO2-UPC/jsoto/Parcial 3/for/" + ".txt";
            FicheroDocente fd = new FicheroDocente(path);
            ...
            for(int i = 1; i<=cant;i++){               
                string pathFor = "C:/UPC/PRO2-UPC/jsoto/Parcial 3/for/";
