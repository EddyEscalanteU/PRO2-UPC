...
/*
            ...
            */
            ...
            string path = "C:/for/douglas2/" + a + ".txt";
            FicheroDouglas fd = new FicheroDouglas(path);
            fd.EscribirArray(AC.ArrayCadenas);
        }
       ...
       /* public static void CrearArchivos(string subFolder, int cant){    
            ...
            for(int i = 1; i<=cant;i++){               
                string pathFor = "C:/Users/USUARIO/Documents/GitHub/PRO2-UPC/dfernandez/Fichero/for/" + subFolder;
